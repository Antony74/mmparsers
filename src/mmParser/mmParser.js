...
var grammar = {
    ...
    {"name": "database", "symbols": ["database$ebnf$1"], "postprocess": h.database},
    ...
    {"name": "block", "symbols": [{"literal":"${"}, "_", "block$ebnf$1", {"literal":"$}"}], "postprocess": h.block},
    ...
    {"name": "variable_stmt", "symbols": [{"literal":"$v"}, "variable_stmt$ebnf$1", "_", {"literal":"$."}], "postprocess": h.variable_stmt},
    ...
    {"name": "floating_stmt", "symbols": [(lexer.has("LABEL") ? {type: "LABEL"} : LABEL), "_", {"literal":"$f"}, "_", "typecode", "_", "variable", "_", {"literal":"$."}], "postprocess": h.floating_stmt},
    ...
    {"name": "essential_stmt", "symbols": [(lexer.has("LABEL") ? {type: "LABEL"} : LABEL), "_", {"literal":"$e"}, "_", "typecode", "_", "essential_stmt$ebnf$1", {"literal":"$."}], "postprocess": h.essential_stmt},
    {"name": "assert_stmt", "symbols": ["axiom_stmt"]},
    {"name": "assert_stmt", "symbols": ["provable_stmt"]},
    {"name": "axiom_stmt", "symbols": [(lexer.has("LABEL") ? {type: "LABEL"} : LABEL), "_", {"literal":"$a"}, "_", "typecode", "_", "assertion", {"literal":"$."}], "postprocess": h.axiom_stmt},
    {"name": "provable_stmt", "symbols": [(lexer.has("LABEL") ? {type: "LABEL"} : LABEL), "_", {"literal":"$p"}, "_", "typecode", "_", "assertion", {"literal":"$="}, "_", "proof", {"literal":"$."}], "postprocess": h.provable_stmt},
